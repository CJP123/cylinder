# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/50_demand.ipynb.

# %% auto 0
__all__ = ['load_demand']

# %% ../nbs/50_demand.ipynb 4
import pandas as pd	
import numpy as np
...
def load_demand(path = None , bed=1,unit=1):
    ...
    df['total_lpm'] = df.sum(axis=1).astype('float16')
    df['total_m3s'] = (df.total_lpm/60000).astype('float16')
    df[f'flow'] = df.total_m3s.astype('float16')
